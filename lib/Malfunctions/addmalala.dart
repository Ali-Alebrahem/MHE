...
class AddErrorala extends StatelessWidget {
   AddErrorala({super.key});
         ...
         Column(
           children: [
            SizedBox(height: 250,width: double.infinity,child: Container(width: double.infinity,
              decoration: BoxDecoration(image:DecorationImage(image: AssetImage("assets/images/ala.jpg",),fit: BoxFit.cover)),
             child:Padding(
